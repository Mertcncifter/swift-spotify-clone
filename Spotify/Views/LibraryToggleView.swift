...
//  Spotify
//
//  Created by mert can çifter on 30.05.2022.
//
...
class LibraryToggleView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        albumsButton.addTarget(self, action: #selector(didTapPlayAlbums), for: .touchUpInside)
    }
    ...
    override func layoutSubviews() {
        ...
        albumsButton.frame = CGRect(x: playlistButton.rigth, y: 0, width: 100, height: 40)
    }
    ...
    @objc private func didTapPlayAlbums(){
        state = .album
        UIView.animate(withDuration: 0.2) {
            self.layoutIndicator()
        }
